...
本工程（``isp_h264_tuning``）是面向 :strong:`PC 端图像质量联调` 的独立工程，通过 Wi-Fi 提供统一的预览服务，支持 ISP 原始帧抓图和 H264E 编码码流两种模式。
...
支持分辨率：:strong:`2304×1296`、:strong:`1920×1080`、:strong:`1280×720` （CLI 支持 ``1080p`` / ``720p`` 简写）。
...
:strong:`Q: PC 连上 7100 但 7150 无数据？`
