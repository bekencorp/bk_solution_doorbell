...
This project (``isp_h264_tuning``) is a standalone :strong:`PC-side image quality tuning` firmware. It provides a unified preview service over Wi-Fi, supporting ISP raw frame capture and H264E encoded stream modes.
