...
This project is the **low-power keepalive variant** of the doorbell solution. It extends `doorbell` with keepalive behavior after multimedia services become idle.
