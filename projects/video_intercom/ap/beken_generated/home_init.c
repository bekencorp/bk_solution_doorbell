...
void init_page_home(bk_lv_ui_t *bk_ui)
{
    ...
    lv_obj_set_size(bk_ui->home, 1080, 1920);
    ...
    lv_obj_set_width(bk_ui->home_status_bar, 1080);
    lv_obj_set_height(bk_ui->home_status_bar, 84);
    ...
    lv_obj_set_x(bk_ui->home_clock, 40);
    lv_obj_set_y(bk_ui->home_clock, 22);
    lv_obj_set_width(bk_ui->home_clock, 200);
    lv_obj_set_height(bk_ui->home_clock, 44);
    ...
    lv_obj_set_style_text_font(bk_ui->home_clock, &lv_font_montserrat_regular_36, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_x(bk_ui->home_dev_title, 390);
    lv_obj_set_y(bk_ui->home_dev_title, 26);
    lv_obj_set_width(bk_ui->home_dev_title, 300);
    lv_obj_set_height(bk_ui->home_dev_title, 40);
    ...
    lv_obj_set_style_text_font(bk_ui->home_dev_title, &lv_font_montserrat_regular_30, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_x(bk_ui->home_net_label, 740);
    lv_obj_set_y(bk_ui->home_net_label, 30);
    lv_obj_set_width(bk_ui->home_net_label, 300);
    lv_obj_set_height(bk_ui->home_net_label, 36);
    ...
    lv_obj_set_style_text_font(bk_ui->home_net_label, &lv_font_montserrat_regular_26, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_x(bk_ui->home_video_card, 36);
    lv_obj_set_y(bk_ui->home_video_card, 100);
    lv_obj_set_width(bk_ui->home_video_card, 1008);
    lv_obj_set_height(bk_ui->home_video_card, 1160);
    ...
    lv_image_set_src(bk_ui->home_feed_img, &door_cam_1024x1536_RGB565A8_NONE);
    lv_image_set_pivot(bk_ui->home_feed_img, 50, 50);
    lv_image_set_rotation(bk_ui->home_feed_img, 0);
    lv_obj_set_x(bk_ui->home_feed_img, -8);
    lv_obj_set_y(bk_ui->home_feed_img, 0);
    lv_obj_set_width(bk_ui->home_feed_img, 1024);
    lv_obj_set_height(bk_ui->home_feed_img, 1536);
    ...
    lv_obj_set_x(bk_ui->home_live_badge, 28);
    lv_obj_set_y(bk_ui->home_live_badge, 28);
    lv_obj_set_width(bk_ui->home_live_badge, 140);
    lv_obj_set_height(bk_ui->home_live_badge, 54);
    ...
    lv_obj_set_style_text_font(bk_ui->home_live_badge, &lv_font_montserrat_regular_26, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_x(bk_ui->home_rec_timer, 760);
    lv_obj_set_y(bk_ui->home_rec_timer, 36);
    lv_obj_set_width(bk_ui->home_rec_timer, 220);
    lv_obj_set_height(bk_ui->home_rec_timer, 40);
    ...
    lv_obj_set_style_text_font(bk_ui->home_rec_timer, &lv_font_montserrat_regular_28, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_x(bk_ui->home_feed_cap, 20);
    lv_obj_set_y(bk_ui->home_feed_cap, 1024);
    lv_obj_set_width(bk_ui->home_feed_cap, 968);
    lv_obj_set_height(bk_ui->home_feed_cap, 116);
    ...
    lv_obj_set_x(bk_ui->home_cap_name, 26);
    lv_obj_set_y(bk_ui->home_cap_name, 18);
    lv_obj_set_width(bk_ui->home_cap_name, 760);
    lv_obj_set_height(bk_ui->home_cap_name, 42);
    ...
    lv_obj_set_style_text_font(bk_ui->home_cap_name, &lv_font_montserrat_regular_32, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_x(bk_ui->home_cap_sub, 26);
    lv_obj_set_y(bk_ui->home_cap_sub, 68);
    lv_obj_set_width(bk_ui->home_cap_sub, 860);
    lv_obj_set_height(bk_ui->home_cap_sub, 34);
    ...
    lv_obj_set_style_text_font(bk_ui->home_cap_sub, &lv_font_montserrat_regular_24, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_x(bk_ui->home_btn_settings, 36);
    lv_obj_set_y(bk_ui->home_btn_settings, 1420);
    lv_obj_set_width(bk_ui->home_btn_settings, 490);
    lv_obj_set_height(bk_ui->home_btn_settings, 150);
    ...
    lv_obj_set_style_text_font(bk_ui->home_btn_settings, &lv_font_montserrat_regular_34, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_x(bk_ui->home_btn_adddev, 554);
    lv_obj_set_y(bk_ui->home_btn_adddev, 1420);
    lv_obj_set_width(bk_ui->home_btn_adddev, 490);
    lv_obj_set_height(bk_ui->home_btn_adddev, 150);
    ...
    lv_obj_set_style_text_font(bk_ui->home_btn_adddev, &lv_font_montserrat_regular_34, LV_PART_MAIN | LV_STATE_DEFAULT);
