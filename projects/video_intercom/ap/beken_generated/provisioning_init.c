...
void init_page_provisioning(bk_lv_ui_t *bk_ui)
{
    ...
    lv_obj_set_size(bk_ui->provisioning, 720, 1280);
    ...
    lv_obj_set_x(bk_ui->provisioning_back_btn, 24);
    lv_obj_set_y(bk_ui->provisioning_back_btn, 27);
    lv_obj_set_width(bk_ui->provisioning_back_btn, 80);
    lv_obj_set_height(bk_ui->provisioning_back_btn, 53);
    ...
    lv_obj_set_style_text_font(bk_ui->provisioning_back_btn, &lv_font_montserrat_regular_18, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_y(bk_ui->provisioning_qr_title, 35);
    lv_obj_set_width(bk_ui->provisioning_qr_title, 720);
    lv_obj_set_height(bk_ui->provisioning_qr_title, 13);
    ...
    lv_obj_set_style_text_font(bk_ui->provisioning_qr_title, &lv_font_montserrat_regular_28, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_y(bk_ui->provisioning_qr_subtitle, 89);
    lv_obj_set_width(bk_ui->provisioning_qr_subtitle, 720);
    lv_obj_set_height(bk_ui->provisioning_qr_subtitle, 13);
    ...
    lv_obj_set_style_text_font(bk_ui->provisioning_qr_subtitle, &lv_font_montserrat_regular_18, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_x(bk_ui->provisioning_qr_instr, 60);
    lv_obj_set_y(bk_ui->provisioning_qr_instr, 133);
    lv_obj_set_width(bk_ui->provisioning_qr_instr, 600);
    lv_obj_set_height(bk_ui->provisioning_qr_instr, 80);
    ...
    lv_obj_set_style_text_font(bk_ui->provisioning_qr_instr, &lv_font_montserrat_regular_18, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_x(bk_ui->provisioning_qr_card, 173);
    lv_obj_set_y(bk_ui->provisioning_qr_card, 257);
    lv_obj_set_width(bk_ui->provisioning_qr_card, 373);
    lv_obj_set_height(bk_ui->provisioning_qr_card, 373);
    ...
    lv_obj_set_x(bk_ui->provisioning_qr_code, 33);
    lv_obj_set_y(bk_ui->provisioning_qr_code, 33);
    lv_obj_set_width(bk_ui->provisioning_qr_code, 307);
    lv_obj_set_height(bk_ui->provisioning_qr_code, 307);
    ...
    lv_obj_set_x(bk_ui->provisioning_btn_home, 60);
    lv_obj_set_y(bk_ui->provisioning_btn_home, 1040);
    lv_obj_set_width(bk_ui->provisioning_btn_home, 600);
    lv_obj_set_height(bk_ui->provisioning_btn_home, 80);
    ...
    lv_obj_set_style_text_font(bk_ui->provisioning_btn_home, &lv_font_montserrat_regular_22, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_x(bk_ui->provisioning_info_card, 64);
    lv_obj_set_y(bk_ui->provisioning_info_card, 691);
    lv_obj_set_width(bk_ui->provisioning_info_card, 600);
    lv_obj_set_height(bk_ui->provisioning_info_card, 167);
    ...
    lv_obj_set_x(bk_ui->provisioning_info_hdr, 20);
    lv_obj_set_y(bk_ui->provisioning_info_hdr, 12);
    lv_obj_set_width(bk_ui->provisioning_info_hdr, 560);
    lv_obj_set_height(bk_ui->provisioning_info_hdr, 13);
    ...
    lv_obj_set_style_text_font(bk_ui->provisioning_info_hdr, &lv_font_montserrat_regular_16, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_x(bk_ui->provisioning_k_name, 20);
    lv_obj_set_y(bk_ui->provisioning_k_name, 47);
    lv_obj_set_width(bk_ui->provisioning_k_name, 200);
    lv_obj_set_height(bk_ui->provisioning_k_name, 13);
    ...
    lv_obj_set_style_text_font(bk_ui->provisioning_k_name, &lv_font_montserrat_regular_18, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_x(bk_ui->provisioning_v_name, 227);
    lv_obj_set_y(bk_ui->provisioning_v_name, 47);
    lv_obj_set_width(bk_ui->provisioning_v_name, 353);
    lv_obj_set_height(bk_ui->provisioning_v_name, 13);
    ...
    lv_obj_set_style_text_font(bk_ui->provisioning_v_name, &lv_font_montserrat_regular_18, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_x(bk_ui->provisioning_k_mac, 20);
    lv_obj_set_y(bk_ui->provisioning_k_mac, 77);
    lv_obj_set_width(bk_ui->provisioning_k_mac, 200);
    lv_obj_set_height(bk_ui->provisioning_k_mac, 13);
    ...
    lv_obj_set_style_text_font(bk_ui->provisioning_k_mac, &lv_font_montserrat_regular_18, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_x(bk_ui->provisioning_v_mac, 227);
    lv_obj_set_y(bk_ui->provisioning_v_mac, 77);
    lv_obj_set_width(bk_ui->provisioning_v_mac, 353);
    lv_obj_set_height(bk_ui->provisioning_v_mac, 13);
    ...
    lv_obj_set_style_text_font(bk_ui->provisioning_v_mac, &lv_font_montserrat_regular_18, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_x(bk_ui->provisioning_k_model, 20);
    lv_obj_set_y(bk_ui->provisioning_k_model, 108);
    lv_obj_set_width(bk_ui->provisioning_k_model, 200);
    lv_obj_set_height(bk_ui->provisioning_k_model, 13);
    ...
    lv_obj_set_style_text_font(bk_ui->provisioning_k_model, &lv_font_montserrat_regular_18, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_x(bk_ui->provisioning_v_model, 227);
    lv_obj_set_y(bk_ui->provisioning_v_model, 108);
    lv_obj_set_width(bk_ui->provisioning_v_model, 353);
    lv_obj_set_height(bk_ui->provisioning_v_model, 13);
    ...
    lv_obj_set_style_text_font(bk_ui->provisioning_v_model, &lv_font_montserrat_regular_18, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_x(bk_ui->provisioning_k_proto, 20);
    lv_obj_set_y(bk_ui->provisioning_k_proto, 139);
    lv_obj_set_width(bk_ui->provisioning_k_proto, 200);
    lv_obj_set_height(bk_ui->provisioning_k_proto, 13);
    ...
    lv_obj_set_style_text_font(bk_ui->provisioning_k_proto, &lv_font_montserrat_regular_18, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_x(bk_ui->provisioning_v_proto, 227);
    lv_obj_set_y(bk_ui->provisioning_v_proto, 139);
    lv_obj_set_width(bk_ui->provisioning_v_proto, 353);
    lv_obj_set_height(bk_ui->provisioning_v_proto, 13);
    ...
    lv_obj_set_style_text_font(bk_ui->provisioning_v_proto, &lv_font_montserrat_regular_18, LV_PART_MAIN | LV_STATE_DEFAULT);
